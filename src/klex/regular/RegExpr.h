...
using RegExpr = std::variant<AlternationExpr, BeginOfLineExpr, CharacterClassExpr, CharacterExpr, ClosureExpr, ConcatenationExpr, DotExpr, EmptyExpr, EndOfFileExpr, EndOfLineExpr, LookAheadExpr>;
