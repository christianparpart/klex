...
class SymbolSet {
  public:
	...
	class const_iterator {  // {{{
	  public:
		const_iterator(std::vector<bool>::const_iterator beg, std::vector<bool>::const_iterator end, size_t n)
...
struct hash<klex::regular::SymbolSet> {
	size_t operator()(const klex::regular::SymbolSet& set) const { return set.hash(); }
};
}  // namespace std
